...
public class RocketMatholdSave {
	...
	public RocketMatholdSave(double m0, double mW, double vB, double p0, double cD, double rBot, double rNoz)
	{
		this.m0 = m0;
		this.mW = mW;
		this.vB = vB;
	...
	public RocketMatholdSave(double m0, double mW, double vB, double p0, double cD, double rBot, double rNoz, double step)
	{
		this.m0 = m0;
		this.mW = mW;
		this.vB = vB;
	...
	public RocketMatholdSave()
	{
		RocketMatholdSave rocket = new RocketMatholdSave(0.76, 0.66, .002, 253312.5, 1,.05, .01);
...
//		System.out.println("Drag" + drag);
	...
	public void doStep ()
	{
		...
		System.out.println("ipc" + iP + " mass " + m + " dM/dt " + dMdt + " velocity " + v + " height " + h);
		t+= step * 100;
//		System.out.println("time " + t);
	...
	public static void printStats(RocketMatholdSave rocket)
	{
