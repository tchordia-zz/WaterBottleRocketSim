...
public class CopyOfSliderPanel extends JPanel implements ChangeListener {
	...
	public static void main(String[] args) 
	{
		...
		frame.add(new CopyOfSliderPanel(), BorderLayout.PAGE_START);
