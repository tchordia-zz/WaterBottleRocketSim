...
public class RocketMath {
    ...
    public static double rBot;
    public static double rNoz;
    public static double vW0;
    public static double vA0;
    public static double iP;
    public static double pW = .001;
	...
	public static RocketMath rocket;
...
//	{
//		
//		RocketMath rocket = new RocketMath ( m0,  mW,  vB,  p0,  cD,  rBot,  rNoz, .01);
//		for (int i = 1; i <= 375; i++)
//			rocket.doStep();
//	}
